...
'class~=^crx_/i' is both. The properties 'type' and 'transient' take neither a
regular expression nor the '/i' suffix: they are always compared as written. 'type'
is one of *normal*, *dock*, *desktop*,
...
given with '~=' or '/i', or a key is neither a property nor an effect.

...
*-a*, *--add* (<class_name>|\*)[:(<instance_name>|\*)[:(<name>|\*)]]|(<property>[~]=<pattern>)... [*-o*|*--one-shot*] <effect>...::
...
expression, and the '/i' suffix on them is accepted but has no effect: they are
always compared as written. 'type' is one of *normal*, *dock*, *desktop*,
*notification*, *dialog*, *utility* or *toolbar*, and 'transient' is a boolean.
...
given with '~=', or a key is neither a property nor an effect.
